...
if not os.path.exists("outputs_6"):
    os.makedirs("outputs_6")
util.save(output= Output, filename="outputs_6"+"/"+"mHrecoil_mumu-chunk6.coffea")
print("File mHrecoil_mumu-chunk6.coffea saved at outputs_6")
