...
if not os.path.exists("outputs_0"):
    os.makedirs("outputs_0")
util.save(output= Output, filename="outputs_0"+"/"+"mHrecoil_mumu-chunk0.coffea")
print("File mHrecoil_mumu-chunk0.coffea saved at outputs_0")
